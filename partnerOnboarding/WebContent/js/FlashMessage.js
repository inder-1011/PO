...
var flashModule = angular.module('ngFlash', []);

flashModule.run(['$rootScope', function ($rootScope) {
    return $rootScope.flashes = [];
}]);

flashModule.directive('dynamic', ['$compile', function ($compile) {
    return {
        restrict: 'A',
        replace: true,
...
flashModule.directive('closeFlash', ['$compile', '$rootScope', 'Flash', function ($compile, $rootScope, Flash) {
    return {
        link: function link(scope, ele, attrs) {
...
flashModule.directive('flashMessage', ['Flash', function (Flash) {
    return {
        restrict: 'E',
        scope: {
            duration: '=',
...
flashModule.factory('Flash', ['$rootScope', '$timeout', function ($rootScope, $timeout) {
    var dataFactory = {};
    var counter = 0;
